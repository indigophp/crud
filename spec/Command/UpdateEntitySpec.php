...
class UpdateEntitySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Indigo\Crud\Command\UpdateEntity');
    }
    ...
    {
        $this->getCommandName()->shouldReturn('service.updateEntity');
    }

    function it_has_an_original_name()
    {
        $this->getOriginalCommandName()->shouldReturn('updateEntity');
    }
